...
function sendResetEmail(email, resetToken) {
  let mailOptions = {
    from: '"Aung Nyein Chann" <aungnyeinchann416@gmail.com>',
    to: email,
    subject: "Reset Password",
    text:
      `You are receiving this because you (or someone else) have requested the reset of the password for your Shop account.\n\n` +
